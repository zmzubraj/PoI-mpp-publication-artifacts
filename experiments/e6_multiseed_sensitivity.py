...
from poi_mpp.experiments.e6_multiseed import execute_e6_multiseed


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Execute frozen E6 multi-seed sensitivity simulation.")
    ...
    result = execute_e6_multiseed(args.config, args.output, repo_root=REPO_ROOT)
