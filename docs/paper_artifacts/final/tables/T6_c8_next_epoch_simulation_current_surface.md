...
| `negative-cap-removed` | `NEGATIVE_CONTROL` | `CONCENTRATION_CAP_REMOVED` | 480 | 0.625 | 0.625 | 0.929688 | 0 | `COMMITTEE_SAMPLED` | 10 | `INCONCLUSIVE` | `REPRODUCIBLE_SIMULATION` | `run-e8-publication-v1` |
