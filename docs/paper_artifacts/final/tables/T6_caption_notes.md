...
- canonical manifest SHA-256 `1e8e57869d68bafdbcbdcf59a81e1f6d6c5d5089188a88f80a99d12748fcb722`.

Units:
- `total_active_weight_micros` is reported in the canonical simulation’s micro-weight units.
- Probability columns are unitless probabilities in the closed interval `[0, 1]`.

Denominators and sample notes:
- `sample_size=10` is the scenario-level sampling count reported by the canonical publication artifact.
